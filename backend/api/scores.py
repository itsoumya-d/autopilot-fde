...
from ..security import client_key, rate_limiter, require_api_key
...
async def simulate_process(
    ...
    Rate-limited per client (AUTOPILOT_RATE_LIMIT_PER_MIN, 60/min default,
    0 disables): an anonymous caller can otherwise spin the CPU with 10k-run
    Monte Carlo loops as fast as HTTP allows.
    """
